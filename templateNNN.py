...
# python mkshim240.py -f "C:\WinP\bd312\bu\WPy64-31250b5\IDLEtest4.exe" -c "Powershell.exe start-process  -FilePath (Join-Path (Get-Location).Path  -ChildPath 'scripts\winidletest.bat')"
...
# python mkshim400.py -f "C:\WinP\bd312\bu\WPy64-31250b5\IDLEtest42s.exe" -c "Powershell.exe start-process  -FilePath (Join-Path -Path $ENV:WINPYDIRICONS -ChildPath 'scripts\winidletest.bat')"
# python mkshim400.py -f "C:\WinP\bd312\bu\WPy64-31250b5\IDLEtest42s.exe" -c "Powershell.exe start-process -WindowStyle Hidden  -FilePath ($ENV:WINPYDIRICONS + '\scripts\winidle.bat')"
